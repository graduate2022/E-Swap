...
body{
    ...
    <body> 
       ...
       <div id="menu">
           <div><a href="insertData.jsp"> <span>Insert User Page </span></a></div> 
           <div><a href="displayData.jsp"><span> Display Users Page</span> </a></div>
           <div><a href="bookorders.jsp">  <span>Order Book Page</span> </a></div>
           <div><a href="DisplayOrder.jsp">  <span>Display Order Page</span> </a></div>       
