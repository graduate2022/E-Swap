				...
				<div class="fadeshop">
					<div class="captionshop text-center" style="display: none;">
						<h3><{{name}}</h3>
                                                ...
                                                <br><br><br><br>
						<p>
						<a href="/Graduate/bookorders.jsp?id={{id}}" class="learn-more detailslearn"><i class="fa fa-money"></i> Cash</a>
						<a href="/Graduate/swapOrder.jsp?id={{id}}" class="learn-more detailslearn"><i class="fa fa-retweet"></i> Swap</a>
						</p>
					</div>
                                                <span class="maxproduct"><img style="height: 333px; width: 332px" src="/Graduate/assets/images/{{imgname}}" alt=""></span>
				</div>
				<div class="product-details">
					<h1>{{name}}</h1>
					<span class="price">
					<span class="edd_price">{{price}} JD</span>
					</span>
				</div>
			</div>
		</div>
...
for(var i=0;i<res.length;i++){
    products+= Mustache.render(tem.innerHTML, res[i]);
}
